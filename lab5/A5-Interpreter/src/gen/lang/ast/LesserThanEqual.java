...
/**
 * @ast node
 * @declaredat /mnt/c/Users/torth/documents/edan65/p003-william-anton/lab5/a5-interpreter/src/jastadd/lang.ast:25
 ...
 */
public class LesserThanEqual extends Comparison implements Cloneable {
  /**
   * @aspect Interpreter
   * @declaredat /mnt/c/Users/torth/documents/edan65/p003-william-anton/lab5/a5-interpreter/src/jastadd/Interpreter.jrag:165
   */
  @Override
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /mnt/c/Users/torth/documents/edan65/p003-william-anton/lab5/a5-interpreter/src/jastadd/PrettyPrint.jrag:122
   */
   ...
   */
  public LesserThanEqual treeCopyNoTransform() {
    LesserThanEqual tree = (LesserThanEqual) copy();
    if (children != null) {
   ...
   */
  public LesserThanEqual treeCopy() {
    LesserThanEqual tree = (LesserThanEqual) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
   ...
   * @apilevel high-level
   */
  public LesserThanEqual seta(Expression node) {
    setChild(node, 0);
    return this;
  }
  /**
   ...
   * @apilevel high-level
   */
  public LesserThanEqual setb(Expression node) {
    setChild(node, 1);
    return this;
  }
  /**
...
protected boolean type_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /mnt/c/Users/torth/documents/edan65/p003-william-anton/lab5/a5-interpreter/src/jastadd/TypeAnalysis.jrag:54
   */
